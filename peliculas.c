...
void altaPeli() {
    ...
    switch(opcionIdioma) {
        case 1: strcpy(alta.idioma, "Español"); break;
...
void modificacionPeli() {
    ...
    printf("Rengrese formato (2D, 3D, 4D): ");
